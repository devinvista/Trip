...
export async function createComprehensiveSeedData() {
  ...
  try {
    ...
    const expenseCategories = [
      { category: "transport", description: "Passagens aéreas", amount: 400 },
      { category: "accommodation", description: "Hospedagem 3 noites", amount: 300 },
      { category: "food", description: "Jantar no restaurante local", amount: 150 },
      { category: "activities", description: "Passeio guiado", amount: 100 },
      { category: "transport", description: "Táxi do aeroporto", amount: 80 },
      { category: "food", description: "Almoço na praia", amount: 120 },
      { category: "other", description: "Souvenirs", amount: 60 }
    ];

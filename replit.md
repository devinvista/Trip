...
- 13 de julho de 2025. Implementação de countdown timer dinâmico com gradientes que mudam conforme dias restantes: vermelho intenso (≤1 dia), laranja/amarelo (≤7 dias), azul/roxo (≤30 dias), verde/azul (≤90 dias), roxo/rosa (>90 dias), transições suaves duration-1000 e acentos de texto harmonizados
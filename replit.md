...
- 13 de julho de 2025. Atualização completa da identidade visual - mudança de marca de "ViajaJunto" para "Viajar Juntos" em toda a aplicação, modernização da seção de funcionalidades com design glassmorphism, cards com gradientes animados, efeitos hover aprimorados e links do rodapé corrigidos para páginas existentes (/search, /create-trip, /dashboard, /profile, /auth)

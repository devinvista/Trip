...
function CountdownTimer({ targetDate }: { targetDate: string }) {
  ...
  if (isPast) {
    return (
      <div className="bg-gradient-to-r from-amber-500 to-orange-500 rounded-lg p-2 sm:p-3 md:p-4 text-white shadow-lg w-full max-w-[280px] sm:max-w-sm">
        <div className="flex items-center justify-center gap-2">
          ...
          <div className="text-center">
            ...
            <p className="text-amber-100 text-xs hidden sm:block">Esperamos que tenha sido incrível!</p>
          </div>
        </div>
      </div>
    );
  ...
  return (
    <div className={`bg-gradient-to-r ${gradientConfig.gradient} rounded-lg p-2 sm:p-3 md:p-4 text-white shadow-lg transition-all duration-1000 w-full max-w-[280px] sm:max-w-sm`}>
      <div className="text-center">
        ...
        <div className="grid grid-cols-4 gap-1 sm:gap-1.5 md:gap-2 max-w-[240px] sm:max-w-xs mx-auto">
          <motion.div
          ...
          >
            <div className="text-xs sm:text-sm md:text-xl font-bold text-white">{timeLeft.days}</div>
          ...
          <motion.div
            ...
            className="bg-white/20 backdrop-blur-sm rounded-lg p-1 sm:p-1.5 md:p-2 border border-white/30"
          >
            <div className="text-xs sm:text-sm md:text-xl font-bold text-white">{timeLeft.hours}</div>
          ...
          <motion.div
            ...
            className="bg-white/20 backdrop-blur-sm rounded-lg p-1 sm:p-1.5 md:p-2 border border-white/30"
          >
            <div className="text-xs sm:text-sm md:text-xl font-bold text-white">{timeLeft.minutes}</div>
          ...
          <motion.div
            ...
            className="bg-white/20 backdrop-blur-sm rounded-lg p-1 sm:p-1.5 md:p-2 border border-white/30"
          >
            <div className="text-xs sm:text-sm md:text-xl font-bold text-white">{timeLeft.seconds}</div>
            <div className={`text-xs ${gradientConfig.textAccent}`}>Seg</div>
          </motion.div>
        </div>
        <p className={`mt-1 sm:mt-2 ${gradientConfig.textAccent} text-xs hidden sm:block`}>
